...
class Practice(db.Model) :
    ...
    director_practice_usu_id = db.Column(db.Integer, db.ForeignKey("director_practice_usu.users_id"))
    director_practice_company_id = db.Column(db.Integer, db.ForeignKey("director_practice_company.users_id"))
